...
/// UserDefaults-backed settings. Edit via Preferences or `defaults write com.dvir.nivi <key> <value>`.
public struct Settings {
    ...
    ///
    /// Nivi used to keep two models in memory and hold them for five minutes. With a
    ...
    ///
    /// On by default. Nivi writes down speech, so a note about a sound is never
