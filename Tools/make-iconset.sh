...
"$TMP/raster" Resources/AppIcon.svg           Resources/NiviLogo.png    256   # Hebrew (aleph)
"$TMP/raster" Resources/DictationIconLatinA.svg Resources/NiviLogoEn.png 256   # English (Latin A)
...
iconutil -c icns "$SET" -o Resources/Nivi.icns
echo "wrote Nivi.icns + NiviLogo.png (He) + NiviLogoEn.png + MenuBar{Aleph,LatinA}.png"
