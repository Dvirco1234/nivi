...
/// Where Nivi shows itself: the theme, the Dock icon and the menu bar icon.
///
...
enum InterfaceSettings {
    ...
    static let changed = Notification.Name("niviInterfaceChanged")
    ...
    /// Nivi must always be reachable from either the Dock or the menu bar. The
