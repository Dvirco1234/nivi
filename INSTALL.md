...
Dictato needs macOS 14 or newer, on an Apple Silicon Mac (M1 and later).

## 1. Download and drag

1. Download `Dictato-<version>.dmg`.
2. Double-click it. A window opens with the Dictato icon and a shortcut to your
   Applications folder.
3. Drag Dictato onto Applications.
4. Eject the disk image.

## 2. The first launch, and the scary message

The first time you open Dictato, macOS blocks it and shows something like:

> **"Dictato" cannot be opened because Apple cannot check it for malicious software.**

or, on some versions:

> **"Dictato" is damaged and can't be opened. You should move it to the Trash.**
...
and Dictato does not have one yet, so the app is signed by its author instead of
...
4. Scroll down to the **Security** section. There is a line saying
   *"Dictato" was blocked to protect your Mac*, with an **Open Anyway** button
   next to it.
5. Click **Open Anyway**, and confirm with your password or Touch ID.
6. Dictato opens. From now on it opens normally, like any other app.

If you do not see the "Open Anyway" line, try opening Dictato once more first.
...
Dictato asks for three things the first time it needs them. Each one opens a
System Settings page where you switch Dictato on.
...
Dictato checks once a day whether a newer version exists, and tells you when
